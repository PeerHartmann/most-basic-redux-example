...
function reducer(
  ...
  action: Action<ActionTypes> & Actions
): State {
  switch (action.type) {
    case "ADD":
...
function renderCounter(props: {
  ...
  const add = (): Action<ActionTypes> =>
    props.dispatch({ type: "ADD", amount: 2 });
  const display = (): Action<ActionTypes> =>
    props.dispatch({ type: "DISPLAY", prefix: "The count" });
  return (
    <div>
